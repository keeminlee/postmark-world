...
| tier field on records | — | none — tier is not a field (B, merged) | derived by the one walk | **CUTOVER** — 94 stale field-carriers on disk are inert; office raw-field readers (world-branches/hydrate/graph) still consume them |
