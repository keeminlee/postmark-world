// thresholds.mjs — enter/exit(mark): the enterexit acts, and the occupancy they derive.
//
...
//
// R10 keeps adjudication epoch-final: the door predicts, the entry settles.
...
//
// One line per ENTER or EXIT, append-only, in the walk ledger's own grammar — the
...
// publish that count. Enterexit rows living in the walk ledger would make every
...
export const LEDGER_HEADER = `# Threshold ledger — the enterexit record
...
/** The ferry crossing's clock value AS THE RECORD WILL HOLD IT — floored to the
...
/** Whether entering past this threshold demands the walker's explicit word. True
...
/** What a walker reads AT the threshold, before he enters. Terms by
...
// entered, root-first, innermost last. Occupancy of a node implies
